...
def main_flow():
    ...
    with requests.Session() as s:
        ...
        # cancel DEBIT SEPA transaction
        try:
            CancelDebitPaymentResponse = s.delete(CancelDebitPaymentAPI + str(paymentID), headers={'Authorization': "Bearer " + loginToken}, verify=False )
            ...
            if (CreateDebitPaymentResponse.status_code in (200, 201, 203, 204)) and (payment_ID is not None):
                logger.info("SEPA DEBIT transaction is canceled")
